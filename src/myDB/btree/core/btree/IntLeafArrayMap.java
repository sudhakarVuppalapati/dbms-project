 ...
 * types.
 */
public class IntLeafArrayMap extends LeafArrayMap {
	 ...
	 * @return
	 */
	public IntLeafArrayMap split() {
		IntLeafArrayMap newMap = new IntLeafArrayMap(keys.length);
