 ...
 * @author jens
 */
public class LongInternalNodeArrayMap extends InternalNodeArrayMap {
	...
	public LongInternalNodeArrayMap(int n) {
		keys = new long[n];
		nodes = new LongBTreeNode[n + 1];

		nodes[0] = myDB.btree.core.btree.LongInternalNode.NULL;
	}
	 ...
	 * @return
	 */
	public void put(long key, LongBTreeNode rightNode) {
		if (currentSize == 0) {
			keys[0] = key;
			nodes[1] = rightNode;
			currentSize++;
	 ...
	 * @return
	 */
	public LongBTreeNode get(long key) {
