 ...
 * @author jens
 */
public class ObjectInternalNodeArrayMap extends InternalNodeArrayMap {
	...
	public ObjectInternalNodeArrayMap(int n) {
		keys = new Comparable[n];
		nodes = new ObjectBTreeNode[n + 1];

		nodes[0] = myDB.btree.core.btree.ObjectInternalNode.NULL;
	}
	 ...
	 * @return
	 */
	public void put(Comparable key, ObjectBTreeNode rightNode) {
		if (currentSize == 0) {
			keys[0] = key;
			nodes[1] = rightNode;
			currentSize++;
	 ...
	 * @return
	 */
	public ObjectBTreeNode get(Comparable key) {
	...
	public String toString() {
		...
		if (nodes[0] == myDB.btree.core.btree.ObjectInternalNode.NULL) {
			sb.append("NULL | ");
		} else {
