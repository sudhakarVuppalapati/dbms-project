...
public class IntInternalNodeArrayMap extends InternalNodeArrayMap {
	...
	public IntInternalNodeArrayMap(int n) {
		keys = new int[n];
		nodes = new IntBTreeNode[n + 1];

		nodes[0] = myDB.btree.core.btree.IntInternalNode.NULL;
	}
	 ...
	 * @return
	 */
	public void put(int key, IntBTreeNode rightNode) {
		if (currentSize == 0) {
			keys[0] = key;
			nodes[1] = rightNode;
			currentSize++;
	 ...
	 * @return
	 */
	public IntBTreeNode get(int key) {
	...
	public String toString() {
		...
		if (nodes[0] == myDB.btree.core.btree.IntInternalNode.NULL) {
			sb.append("NULL | ");
		} else {
