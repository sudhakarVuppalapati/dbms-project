...
public class JoinOperator {
	...
	/**
	 * <b>Simple Nested loops</b> implementation:the basic join implementation.
	 * Even if is not the smartest join implementation it might be the only
	 * solution (Block nested loops doesn't make sense since we're not dealing
	 * with I/O)
	 */

	public static Map<String, Column> joinSimple(Map<String, Column> input1,
			Map<String, Column> input2, String leftAttr, String rightAttr)
		 ...
		 */
			...
			for (i = 0; i < leftColSize; i++)
				for (j = 0; j < rightColSize; j++) {
					/*
					 * str1=(String)objArrLeft[i]; str2=(String)objArrRight[j];
					 */
		...
		// take the first map of columns,recreate the new arrays and set them as
		// data of the column
		...
		// besides that add the columns of this hashmap to the first input
		// hashmap
