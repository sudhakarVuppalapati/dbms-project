...
public class TableTest extends TestCase {
	...
	public void tearDown() throws Exception {
		...
		Operator<Table> op = myDatabase.getStorageInterface().getTables();
	...
	public void testGetAllColumns() {
		...
		try {
			op = (myDatabase.getStorageInterface().getTableByName(tName))
					.getAllColumns();
		} catch (NoSuchTableException e) {
			fail("unexpected");
		}
	...
	public void testGetRowsWithPredicate() {
		...
		try {
			...
			rowOp = myDatabase.getStorageInterface().getTableByName(tName)
					.getRows(predicate);
